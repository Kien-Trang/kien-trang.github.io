...
profiles:
  - icon: at-symbol
    url: 'kien.trang@monash.edu'
    label: E-mail Me
  - icon: brands/github
    url: https://github.com/Kien-Trang/
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/kien-trang-104895288/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?user=L97unocAAAAJ&hl=en
